...
const socials = [
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
        <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-2.88 2.5 2.89 2.89 0 0 1-2.89-2.89 2.89 2.89 0 0 1 2.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 0 0-.79-.05 6.34 6.34 0 0 0-6.34 6.34 6.34 6.34 0 0 0 6.34 6.34 6.34 6.34 0 0 0 6.33-6.34V8.69a8.18 8.18 0 0 0 4.79 1.52V6.74a4.85 4.85 0 0 1-1.02-.05z" />
      </svg>
    ),
  },
  {
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm text-[#f5f0e8]/50">
              <li>
                General:{" "}
                <a href="mailto:islandparty@purduebyx.com" className="hover:text-[#cfb358] transition-colors">
                  islandparty@purduebyx.com
                </a>
              </li>
              <li>
                Sponsorships:{" "}
                <a href="mailto:sponsor@purduebyx.com" className="hover:text-[#cfb358] transition-colors">
                  sponsor@purduebyx.com
                </a>
              </li>
